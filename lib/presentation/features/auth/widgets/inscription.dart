    ...
    Widget build(BuildContext context){
        return FractionallySizedBox(
            ...
            child: Container(
                ...
                child: Column(
                    children: [
                        Text("Inscription", style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold,),),
                        ...
                        GestureDetector(
                            ...
                            child: Text("Connectez vous?", style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Theme.of(context).colorScheme.secondary),)),
                        SizedBox(height: AppSpacing.space32(context),),
                    ],
                ),
            ),
